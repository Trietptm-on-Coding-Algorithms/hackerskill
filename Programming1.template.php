		...
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor" style="margin-top: 1px;">
			<tr>
				...
				<td class="windowbg" align="left">
					มีเวลาให้ <b>', $context['program']['time'], '</b> วินาที สำหรับคำนวนว่า รหัสแอสกี้ (<a href="http://go.hackerskill.net/http://en.wikipedia.org/wiki/ASCII" rel="nofollow" title="ASCII on WIKI">ASCII</a>) รวมของข้อความข้างล่างนี้ มีค่าเท่าไหร่
					<br />โดยที่ไม่คำนวน ช่องว่าง, การขึ้นบรรทัดใหม่<p>
					ตัวอย่างเช่นคำว่า <b>CAR = C(67) + A(65) + R(82) = 214</b></p>
